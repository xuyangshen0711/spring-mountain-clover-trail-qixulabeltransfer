...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Br8vkhZh.mjs");
...
var manifest = {
	"d2423199665ddae46ba54e458c4e7522c9bdf0734de4ddaf305489537f0e4855": {
		functionName: "saveStyle_createServerFn_handler",
		importer: () => import("./style-api-Cx7onVPw.mjs")
	},
	"eb76b2539c3eb1a49ee3705aa772922ba6be1cc4142808685cd2d17eb6becdc7": {
		functionName: "listStyles_createServerFn_handler",
		importer: () => import("./style-api-Cx7onVPw.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B6864OJh.mjs").then((n) => n.t),
